...
def test_manifest_with_comments_app():
    ...
    if sys.platform == "win32":
        ...
        server_cmd = os.path.join(
            base_path, "manifest_with_comments_app/bin/manifest_with_comments_app.exe"
        )
        client_cmd = os.path.join(base_path, "manifest_with_comments_app_client.exe")
        ...
        server_cmd = os.path.join(
            base_path, "manifest_with_comments_app/bin/manifest_with_comments_app"
        )
        client_cmd = os.path.join(base_path, "manifest_with_comments_app_client")
    else:
        # client depends on some libraries in the TEN app.
    ...
    if not is_started:
        print("The manifest_with_comments_app is not started after 10 seconds.")
